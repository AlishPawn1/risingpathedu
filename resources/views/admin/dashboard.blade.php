  ...
  <section class="dashboard py-5 bg-light">
    <div class="container-fluid px-4">
      <div class="card shadow-sm border-0 rounded-3">
        <div class="card-header border-0 rounded-top py-3 bg-white">
          <div class="d-flex justify-content-between align-items-center">
            <h1 class="h3 fw-bold mb-0">Admin Dashboard</h1>
            <a href="{{ route('logout') }}" class="btn btn-outline-danger">Sign Out</a>
          </div>
        </div>
        <div class="card-body p-4">
          <div class="mb-4">
            <div class="card border-0 shadow-sm bg-light-subtle">
              <div class="card-body">
                <h5 class="card-title text-muted mb-3">Session Information</h5>
                <div class="row">
                  <div class="col-md-6">
                    <p class="mb-2"><strong>Name:</strong> Admin</p>
